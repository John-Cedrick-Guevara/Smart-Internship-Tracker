...
export default function InternshipForm({
    ...
    const [status, setStatus] = useState<InternshipStatus>('wishlist');
    const [isPaid, setIsPaid] = useState(true);

    // AI Image Upload Mock State
    ...
    useEffect(() => {
        if (internship) {
            setCompanyName(internship.company_name);
            setCompanyEmail(internship.company_email);
    ...
    // Simulated Image drag and drop handlers
    ...
    // Simulated AI parsing feature that pre-fills forms
    const simulateAIParsing = () => {
        setIsParsing(true);
        setTimeout(() => {
            // Mock-fill the form with smart parsed data
            setCompanyName('Vercel');
            setCompanyEmail('careers@vercel.com');
            setPosition('Solutions Engineer Intern');
            setLocation('Remote (US/Canada)');
            setDuration('4 Months');
            setUrl('https://vercel.com/careers');
            setStatus('applied');
            setIsPaid(true);
            setIsParsing(false);
        }, 2200);
                    ...
                    <div className="bg-gray-50/50 px-6 py-4 border-b border-gray-250/60 dark:bg-gray-950/20 dark:border-gray-800/80">
                        <div className="flex items-center justify-between">
                            <h3 className="text-lg font-bold text-gray-900 dark:text-white" id="modal-title">
                                {internship ? 'Edit Internship Details' : 'Add Internship Application'}
                            </h3>
                            <button
                                type="button"
                    ...
                    <Tabs defaultValue="details" className="w-full">
                        ...
                        <div className="px-6 pt-4">
                            <TabsList className="grid w-full grid-cols-2">
                                <TabsTrigger value="details">Application Fields</TabsTrigger>
                                <TabsTrigger value="ai-scan">
                                    <span className="flex items-center space-x-1">
                                        <svg className="h-3.5 w-3.5 text-indigo-550 dark:text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="px-6 pb-5 space-y-4">
                                    ...
                                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                        <div>
                                            <label htmlFor="company_name" className="block text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">
                                                Company Name
                                            </label>
                                            <Input
                                                type="text"
                                        ...
                                        <div>
                                            <label htmlFor="company_email" className="block text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">
                                    ...
                                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                        <div>
                                            <label htmlFor="position" className="block text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">
                                                Role / Position
                                            </label>
                                            <Input
                                                type="text"
                                        ...
                                        <div>
                                            <label htmlFor="location" className="block text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">
                                                Location
                                            </label>
                                            <Input
                                                type="text"
                                    ...
                                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                        <div>
                                            <label htmlFor="duration" className="block text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">
                                                Duration
                                            </label>
                                            <Input
                                                type="text"
                                        ...
                                        <div>
                                            <label htmlFor="url" className="block text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">
                                    ...
                                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                        <div>
                                            <label htmlFor="status" className="block text-xs font-bold uppercase tracking-wider text-gray-500 dark:text-gray-400">
                                                Application Status
                                            </label>
                                            <select
                                                name="status"
                                        ...
                                        <div>
                                            ...
                                            <div className="mt-1 flex space-x-3">
                                                <label className={`flex flex-1 items-center justify-center cursor-pointer border rounded-xl px-3 py-2.5 text-xs font-bold transition-all ${
                                                    isPaid 
                                ...
                                <div className="bg-gray-50/50 px-6 py-4 border-t border-gray-250/60 flex justify-end space-x-3 dark:bg-gray-950/20 dark:border-gray-800/80">
                                    ...
                                    <Button
                                        type="submit"
                                    >
                                        {internship ? 'Save Changes' : 'Submit Application'}
                                    </Button>
                                </div>
                            </form>
                        </TabsContent>
                                    ...
                                    {isParsing ? (
                                        <div className="flex flex-col items-center py-6">
                                            ...
                                            <p className="mt-1 text-xs text-gray-500 dark:text-gray-450">
                                                Analyzing details and extraction parameters.
                                            </p>
                                        </div>
                                    ) : selectedImage ? (
                                        <div className="w-full flex flex-col items-center">
                                            <div className="relative rounded-xl overflow-hidden max-h-48 shadow-md border border-gray-200 dark:border-gray-850">
                                                <img src={selectedImage} alt="Uploaded listing" className="object-cover max-w-full h-auto" />
                                                <div className="absolute inset-0 bg-gradient-to-t from-gray-900/60 to-transparent flex items-end justify-center p-3">
                                                    <span className="text-[10px] font-bold text-white uppercase bg-indigo-600 px-2 py-0.5 rounded-full flex items-center">
                                                        <svg className="mr-1 h-3 w-3 animate-ping" fill="currentColor" viewBox="0 0 24 24">
                                            ...
                                            <p className="mt-1 text-xs text-gray-500 dark:text-gray-400 max-w-xs">
                                                Switch to the <b>Application Fields</b> tab to review and submit the pre-filled information.
                                            </p>
                                        ...
                                        <div className="flex flex-col items-center">
                                            ...
                                            <p className="text-sm font-bold text-gray-900 dark:text-white">
                                                Drag and drop internship screenshot here
                                            </p>
                                            <p className="mt-1 text-xs text-gray-500 dark:text-gray-450 max-w-xs">
                                                Supports PNG, JPG, or PDF. Soon, our AI will automatically parse and populate your application fields!
                                            </p>
