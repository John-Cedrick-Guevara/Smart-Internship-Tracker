...
export default function DetailPanel({
    ...
    // Active detail tab ('timeline' | 'notes')
            ...
            <div className="absolute inset-y-0 right-0 pl-10 max-w-full flex">
                ...
                <div className="w-screen max-w-xl bg-white dark:bg-gray-900 shadow-2xl flex flex-col h-full border-l border-gray-200 dark:border-gray-800 transition-transform duration-300 animate-slide-in">
                    ...
                    <div className="flex-1 overflow-y-auto p-6 space-y-6">
                        {/* Info details grid */}
                        <div className="grid grid-cols-2 gap-4 rounded-xl border border-gray-150 dark:border-gray-800 p-4 bg-gray-50/30 dark:bg-gray-950/10">
                            <div>
                        ...
                        <div className="flex border-b border-gray-200 dark:border-gray-800">
                            ...
                            >
                                Timeline & Milestones ({internship.timeline.length})
                            </button>
                            <button
                            ...
                            >
                                Notes Journal ({internship.notes.length})
                            </button>
                        </div>
                                ...
                                {isAddingEvent && (
                                    <form onSubmit={handleAddEventSubmit} className="rounded-xl border border-indigo-150 p-4 bg-indigo-50/15 dark:border-indigo-900/40 dark:bg-indigo-950/10 space-y-3 animate-fade-in">
                                        <div className="grid grid-cols-2 gap-3">
                                            ...
                                            <div>
                                                <label className="block text-[10px] font-bold text-gray-500 uppercase">Event Title</label>
                                                <input
                                                    type="text"
                                                    required
                                        ...
                                        <div>
                                            <label className="block text-[10px] font-bold text-gray-500 uppercase">Reminder Note (Optional)</label>
                                            <input
                                                type="text"
                                        ...
                                        <div className="flex justify-end space-x-2 pt-1">
                                            <button
                                                ...
                                                className="rounded-md px-3 py-1.5 text-[11px] font-semibold text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-800"
                                            >
                                                Cancel
                                            </button>
                                            <button
                            ...
                            <div className="space-y-4">
                                ...
                                {isAddingNote && (
                                    <form onSubmit={handleAddNoteSubmit} className="rounded-xl border border-indigo-150 p-4 bg-indigo-50/15 dark:border-indigo-900/40 dark:bg-indigo-950/10 space-y-3 animate-fade-in">
                                        <div>
                                            <label className="block text-[10px] font-bold text-gray-500 uppercase">Note Title</label>
                                            <input
                                                type="text"
                                                required
                                        ...
                                        <div>
                                            <label className="block text-[10px] font-bold text-gray-550 uppercase">Details</label>
                                            <textarea
                                        ...
                                        <div className="flex justify-end space-x-2 pt-1">
                                            <button
                                                ...
                                                className="rounded-md px-3 py-1.5 text-[11px] font-semibold text-gray-505 hover:bg-gray-100 dark:hover:bg-gray-800"
                                            >
                                                Cancel
                                            </button>
                                            <button
                                ...
                                {internship.notes.length === 0 ? (
                                    ...
                                    <div className="grid grid-cols-1 gap-3">
                                        {internship.notes.map(note => (
                                            <div 
                                                key={note.id}
                                                className="group relative rounded-xl border border-gray-150 bg-amber-50/20 p-4 dark:border-gray-800 dark:bg-gray-950/20"
                                            >
